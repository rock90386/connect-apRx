...
public:
  ...
  virtual NetDeviceContainer Install (Ptr<Node> node, Callback<void, Ptr<Packet>> cb) const;
...
protected:
  ...
  virtual Ptr<NetDevice> InstallPriv (Ptr<Node> node, Callback<void, Ptr<Packet>> cb) const;
