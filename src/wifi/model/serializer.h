...
inline std::string serialize ( SerializableType& a )
{
    return a.serialize ( );
}

template<typename SerializableType>
inline int deserialize ( std::string &str, SerializableType& a )
{
...
#define DEF_BASIC_TYPE_SERIALIZE(Type) \
 template<> \
inline std::string serialize(Type& b) \
{ \
        std::string ret; \
...
#define DEF_BASIC_TYPE_DESERIALIZE(Type)  \
 template<> \
inline int deserialize(std::string& str,Type& b)\
{ \
...
template<>
inline std::string serialize ( std::string& s )
{
    int len = s.size ( );
    std::string ret;
...
template<>
inline int deserialize ( std::string &str, std::string& s )
{
    int len;
    ::deserialize ( str, len );
